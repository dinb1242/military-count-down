...
export const BtnToAdmin: NextPage = () => {
  ...
  return (
    <a
      ...
      className={
        "ring-1 flex justify-center items-center w-48 px-2 py-2 font-bold text-center text-xl select-none hover:ring-2 hover:duration-200 hover:cursor-pointer active:ring-4"
      }
    >
